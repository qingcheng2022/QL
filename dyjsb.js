...
function UserInfo(seesion = '', device_id = '', iid = '') {
    ...
    function excitation_ad_treasure_box() {
        return new Promise(resolve => {
            let url = `https://aweme.snssdk.com/luckycat/aweme/v1/task/done/excitation_ad_treasure_box?mode=done&iid=${iid}&device_id=${device_id}&app_name=${app_name}&version_name=${version_name}&aid=${aid}&device_platform=android&dpi=411&update_version_code=25109900`;
            const options = {
                url: url,
                headers: {
                    'Host': 'aweme.snssdk.com',
